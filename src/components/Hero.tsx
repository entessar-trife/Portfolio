...
const Hero = () => {
  return (
    <div className="relative flex flex-col items-center justify-center h-screen bg-linear-to-r from-blue-500 to-purple-600 text-white overflow-hidden px-5 text-center">
      {/* BACKGROUND SHAPES */}
